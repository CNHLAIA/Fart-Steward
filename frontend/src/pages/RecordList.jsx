  ...
  return (
    <div className="pb-20">
      <div className="bg-purple-600 text-white p-6 rounded-b-3xl shadow-lg mb-6 -mx-4 sm:mx-0 sm:rounded-3xl">
        <h1 className="text-3xl font-bold mb-2">Fart Tracker</h1>
        <p className="opacity-90">Farts today: <span className="text-2xl font-bold ml-1">{todayCount}</span></p>
      </div>
      ...
      <div className="px-4 sm:px-0">
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <h3 className="text-xl font-medium text-gray-900">No records yet</h3>
            <p className="text-gray-500 mt-2 mb-6">Start tracking your gas!</p>
            <button
